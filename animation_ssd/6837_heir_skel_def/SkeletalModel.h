...
private:
	...
	//void recursiveJointHelper(Joint* joint);
	//void recursiveBoneHelper(Joint* joint);
	void jointHelper(Joint* joint);
	void boneHelper(Joint* joint);

	void bindWorldToJointHelper(Joint* joint, Matrix4f m);
	void currentJointToWorldHelper(Joint* joint, Matrix4f m);
